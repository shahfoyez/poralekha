<?php
namespace ABlocks\Blocks\StoreengineCheckoutButton;
...
class Block extends BlockBaseAbstract {
	protected $block_name = 'storeengine-checkout-button';
	...
	public function get_checkout_button_wrapper_css( $attributes, $device = '' ) {
		$css = [];
		$alignment_css = [];
	...
	public function get_checkout_button_css( $attributes, $device = '' ) {
		$css = [];
	...
	public function get_checkout_button_hover_css( $attributes, $device = '' ) {
			return array_merge(
	...
	public function render_block_content( $attributes, $content, $block_instance ) {
		$attr_array = [];
		$shortcode = '[storeengine_proceed_to_checkout ' . Helper::attr_shortcode( $attr_array ) . ']';
