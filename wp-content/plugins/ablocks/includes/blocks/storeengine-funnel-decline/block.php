<?php
namespace ABlocks\Blocks\StoreengineFunnelDecline;
...
class Block extends BlockBaseAbstract {
	protected $block_name = 'storeengine-funnel-decline';
	...
	public function render_block_content( $attributes, $content, $block_instance ) {
		...
		$shortcode = '[storeengine_funnel_skip ' . Helper::attr_shortcode( $attr_array ) . ']';
