<?php
namespace ABlocks\Blocks\StoreengineFunnelAccept;
...
class Block extends BlockBaseAbstract {
	protected $block_name = 'storeengine-funnel-accept';
	...
	public function render_block_content( $attributes, $content, $block_instance ) {
		...
		$shortcode = '[storeengine_funnel_accept ' . Helper::attr_shortcode( $attr_array ) . ']';
