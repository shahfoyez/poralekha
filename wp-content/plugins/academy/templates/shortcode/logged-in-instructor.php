...
$is_instructor = in_array( 'academy_instructor', (array) $user->roles, true );

?>
<div class="academy-reg-thankyou">
	<?php if ( $is_instructor ) : ?>
	<h2 class="academy-reg-thankyou__heading"><?php esc_html_e( 'Congratulations! You are now registered as a instructor.', 'academy' ); ?></h2>
