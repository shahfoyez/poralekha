...
class Validation {
	 ...
	 * @return bool
	 */
	public static function is_phone( ?string $phone ): bool {
	...
	public static function is_postcode( ?string $postcode, string $country ): bool {
		...
		switch ( $country ) {
			...
			case 'GB':
				...
				break;
			case 'IE':
				$valid = (bool) preg_match( '/([AC-FHKNPRTV-Y]\d{2}|D6W)[0-9AC-FHKNPRTV-Y]{4}/', Formatting::normalize_postcode( $postcode ) );
				break;
			case 'IN':
		...
		return apply_filters( 'storeengine/validate_postcode', $valid, $postcode, $country );
	}
	 ...
	 * @return bool
	 */
	public static function is_gb_postcode( string $to_check ): bool {
